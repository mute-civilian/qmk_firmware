...
const uint16_t PROGMEM combo_slack[]       = { KC_SJ,     KC_GK,      COMBO_END};
const uint16_t PROGMEM combo_slack_ch[]    = { KC_SJ,     KC_AL,      COMBO_END};
const uint16_t PROGMEM combo_slack_srch[]  = { KC_SJ,     KC_CSCLN,   COMBO_END};
...
combo_t key_combos[] = {
  ...
  [COMBO_SLACK]         = COMBO( combo_slack,       LGUI(KC_K)),
  [COMBO_SLACK_CH]      = COMBO( combo_slack_ch,    LGUI(KC_F)),
  [COMBO_SLACK_SRCH]    = COMBO( combo_slack_srch,  LGUI(KC_G)),
